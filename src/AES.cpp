...
int main(int argc, char* argv[]) {
    ...
    printHex(pt, 16, (char*)"plain data:"); // Распечатываем исходные данные в виде открытого текста
    printf("expect cipher:\n39 25 84 1D 02 DC 09 FB DC 11 85 97 19 6A 0B 32\n");  // Содержимое данных после обычной расшифровки

    printHex(ct, 16, (char*)"after encryption:");  // Распечатываем зашифрованный зашифрованный текст

    aesDecrypt(key, 16, ct, plain, 16);       // расшифровать
    printHex(plain, 16, (char*)"after decryption:"); // Выводим расшифрованные данные в виде открытого текста
    ...
    printHex(ct2, 32, (char*)"after encryption:");
    ...
    printHex(plain2, 32, (char*)"after decryption:");
